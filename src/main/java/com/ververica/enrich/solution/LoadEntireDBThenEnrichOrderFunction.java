...
public class LoadEntireDBThenEnrichOrderFunction extends RichMapFunction<Order, EnrichedOrder> {
    protected transient DatabaseClient dbClient;
    protected DatabaseClientParameter dbClientParameter;
    protected transient HashMap<Integer, Customer> allCustomers;

    public LoadEntireDBThenEnrichOrderFunction(DatabaseClientParameter dbClientParameter) {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        dbClient.fetchAllCustomers()
                .forEach(customer -> allCustomers.put(customer.getId(), customer) );
    }
