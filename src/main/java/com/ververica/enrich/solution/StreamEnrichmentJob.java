...
public class StreamEnrichmentJob {
	...
	private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(StreamEnrichmentJob.class);
	...
	public static void main(String[] args) throws Exception {
		...
		boolean runInIDE = params.getBoolean("local", true);
		if ( runInIDE ) {
		...
		switch (enrichMethod) {
			...
			case "perRecordLookupAsync":
				...
				break;
			case "perRecordLookupAsyncCache":
				enrichedStream = AsyncDataStream.unorderedWait(
						orderStream,
